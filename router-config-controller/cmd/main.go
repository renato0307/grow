...
import (
	...
	"github.com/renato0307/grow/router-config-controller/internal/controller"
...
func init() {
	...
	utilruntime.Must(routerv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4cb2e441.willful.be",
